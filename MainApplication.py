...
class RunConfigurationDlg(QDialog,
    ...
    def __init__(self, KWARGS, RunArgs, parent=None):
        ...
        self.settings = QSettings('siZors', 'SMUExperiments')
        self._KWARGS = KWARGS
        ...
        self.ComplianceLevel = self.settings.value(
            'ComplianceLevel').toDouble()
    ...
    def updateUI(self):
        ...
        # Compliance Level
        self.Compliance.setProperty(
            "value", self.settings.value(
                'ComplianceLevel', 200).toDouble()[0])
        ...
        # QLineEdit
        # PathDisplay
        self.PathDisplay.setText(self.settings.value('DataPath').toString())
        # QPushButton
        # BrowseButton
    ...
    def setPathDlg(self):
        ...
        path = QFileDialog.getExistingDirectory(
            ...
            str(self.settings.value('DataPath').toString()))
        if path:
            self.settings.setValue(
                'DataPath', str(QDir.toNativeSeparators(path)))
            self.updateUI()
    ...
    def updateDict(self):
        ...
        self.settings.setValue('ComplianceLevel', self.Compliance.value())
...
class MainWindow(QMainWindow,
    ...
    def updateArguments(self):
        ...
        self._KWARGS['DataPath'] = str(
            self.settings.value('DataPath').toString()) + '\\'
